...
#### Functions to compute OTCE Task Transferability Score
## Refer to https://github.com/tanyang1231/OTCE_Transferability_CVPR21/blob/main/compute_otce_demo.py
# Sample code to use:
# P, W = compute_coupling(src_x, tar_x, src_y, tar_y)
# ce = compute_CE(P, src_y, tar_y)
# otce = lambda1*W + lambda2*ce + lambda3 where lambda1, lambda2, lambda3 are coefficients
import ot, geomloss, math
